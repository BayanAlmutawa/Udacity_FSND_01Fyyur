...
# connect to a local postgresql database and migration
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgres://postgres:1234@localhost:5432/fyyurdb'
...
# import all models we need from models.py:
from models import *
